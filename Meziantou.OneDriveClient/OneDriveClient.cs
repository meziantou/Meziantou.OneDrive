...
namespace Meziantou.OneDriveClient
{
    public class OneDriveClient : IDisposable
    {
        ...
        public string[] Scopes { get; set; } = { "wl.signin", "wl.offline_access", "onedrive.readwrite" };
        public string ReturnUrl { get; set; } = "https://login.live.com/oauth20_desktop.srf";
        ...
        public async Task<bool> AuthenticateAsync(bool force = false, CancellationToken ct = default(CancellationToken))
        {
